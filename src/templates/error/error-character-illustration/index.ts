// Character Illustration error page template
// Based on: https://www.youtube.com/watch?v=AM8QBbv_e4Q&t=6s
// Features: animated character illustrations, swinging animations, CSS-driven animations

import type { FlowScreenTemplate } from "../../types";

export const characterIllustrationTemplate: FlowScreenTemplate = {
  html: `<div class="ef-character-illustration-wrapper flowscreen-error-container">
  <div class="ef-character-illustration-container">
    <div class="ef-character-illustration-content">
      <svg class="ef-character-illustration-svg" width="100%" height="auto" viewBox="0 0 636 324" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="OBJECTS">
          <g id="Group">
          ...
          <g id="Group_7">
            <path id="Vector_24" class="ef-character-illustration-code-text" d="M237.3 191.1V97.5H201.8V97.8L159 166.6L140.3 196.7L142.4 218.4H201.8V251H237.3V218.4H253V191H237.3V191.1ZM201.8 191.1H174.2L199.6 147.4L201.8 143.8V191.1Z" fill="url(#paint6_linear)"/>
            <text id="ef-character-illustration-four-1" class="ef-character-illustration-code" x="219" y="174" font-size="var(--ef-code-size, 80px)" font-weight="var(--ef-code-weight, 700)" fill="url(#paint6_linear)" text-anchor="middle">4</text>
            <g id="zero">
              <path id="Vector_25" class="ef-character-illustration-code-text" d="M361.2 110.3C351.9 99 338.7 93.3 321.6 93.3C304.6 93.3 291.4 98.9 282.1 110.2C272.8 121.5 268.1 137.4 268.1 158.2V186.3C268.1 206.9 272.8 222.9 282.1 234.2C291.5 245.5 304.7 251.2 321.8 251.2C338.7 251.2 351.9 245.6 361.2 234.3C370.5 223 375.2 207.1 375.2 186.3V158.3C375.2 137.6 370.5 121.6 361.2 110.3ZM303.8 151.3C304 141 305.5 133.4 308.3 128.3C311.1 123.2 315.5 120.7 321.6 120.7C327.9 120.7 332.4 123.4 335.3 128.9C338.2 134.4 339.6 142.6 339.6 153.6V191.6C339.5 202.6 338.1 210.7 335.2 215.9C332.3 221.1 327.8 223.7 321.8 223.7C315.5 223.7 311 221 308.1 215.7C305.4 210.7 303.9 202.9 303.8 192.5C303.8 191.9 303.8 191.2 303.8 190.6V151.3V151.3Z" fill="url(#paint7_linear)"/>
              <text id="ef-character-illustration-zero" class="ef-character-illustration-code" x="300" y="174" font-size="var(--ef-code-size, 80px)" font-weight="var(--ef-code-weight, 700)" fill="url(#paint7_linear)" text-anchor="middle" dominant-baseline="middle">0</text>
            ...
            <path id="Vector_26" class="ef-character-illustration-code-text" d="M487.5 191.1V97.5H452V97.8L390.5 196.7L392.6 218.4H452V251H487.5V218.4H503.1V191H487.5V191.1ZM452 191.1H424.4L449.8 147.4L452 143.8V191.1V191.1Z" fill="url(#paint8_linear)"/>
            <text id="ef-character-illustration-four-2" class="ef-character-illustration-code" x="400" y="174" font-size="var(--ef-code-size, 80px)" font-weight="var(--ef-code-weight, 700)" fill="url(#paint8_linear)" text-anchor="middle" dominant-baseline="middle">4</text>
      ...
      <div class="ef-character-illustration-text">
        <h1 class="ef-character-illustration-title">{{title}}</h1>
        <div class="ef-character-illustration-description">{{description}}</div>
        <div class="ef-character-illustration-button-container">{{button}}</div>
      </div>
    </div>
  </div>
</div>`,
...
.ef-character-illustration-container {
  display: flex;
...
.ef-character-illustration-content {
  display: flex;
  flex-direction: column;
  align-items: center;
  max-width: 800px;
...
/* Animations */
#handboy {
  animation: ef-character-illustration-swing 1.3s ease-in-out infinite alternate;
...
#hairgirl {
  animation: ef-character-illustration-swinghair 1.3s ease-in-out infinite alternate;
...
#zero {
  ...
  transform-box: fill-box;
  animation: ef-character-illustration-zero-animate 2s ease-in-out infinite;
}

@keyframes ef-character-illustration-swing {
  0% { transform: rotate(10deg); }
  100% { transform: rotate(-10deg); }
}

@keyframes ef-character-illustration-swinghair {
  0% { transform: rotate(6deg); }
  100% { transform: rotate(-6deg); }
}

@keyframes ef-character-illustration-zero-animate {
  0%, 100% {
    transform: translateX(0) scale(1) rotateY(0deg);
  }
  25% {
    transform: translateX(10px) scale(1.4) rotateY(90deg);
  }
  50% {
    transform: translateX(0) scale(1) rotateY(180deg);
  }
  75% {
    transform: translateX(-10px) scale(1.4) rotateY(270deg);
  }
}

/* Hide original path-based text, show SVG text elements */
.ef-character-illustration-code-text {
  opacity: 0;
  pointer-events: none;
}

.ef-character-illustration-code {
  font-size: var(--ef-code-size, 80px);
...
/* Text Content */
.ef-character-illustration-text {
  text-align: center;
  width: 100%;
  max-width: 600px;
}
...
.ef-character-illustration-title {
  ...
  color: var(--ef-title-color, #2F1829);
  margin: 0 0 1.5rem 0;
}
...
.ef-character-illustration-description {
  ...
  color: var(--ef-description-color, #2F1829);
  line-height: 1.6;
  margin: 0 0 2rem 0;
}

.ef-character-illustration-description p {
  margin: 0.5rem 0;
}

.ef-character-illustration-description p:first-child {
  margin-top: 0;
}

.ef-character-illustration-description p:last-child {
  margin-bottom: 0;
}
...
.ef-character-illustration-button-container .flowscreen-error-button {
  font-size: var(--ef-button-size, 1rem);
  font-weight: var(--ef-button-weight, 600);
  color: var(--ef-button-color, #fff);
  background: var(--ef-button-background, #2F1829);
  border: none;
  ...
  box-shadow: 0 4px 15px rgba(47, 24, 41, 0.2);
}

.ef-character-illustration-button-container .flowscreen-error-button:hover {
  background: #3B223C;
  transform: translateY(-2px);
  box-shadow: 0 6px 20px rgba(47, 24, 41, 0.3);
}

.ef-character-illustration-button-container .flowscreen-error-button:active {
  transform: translateY(0);
  box-shadow: 0 2px 10px rgba(47, 24, 41, 0.2);
}
